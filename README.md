...
of the county's area. It is meant for map markers/labels, not survey-grade
geodata.

- **County codes and names, and the county → administrative-capital
  mapping**: [Statistics Sweden (SCB), Counties and municipalities in
  Sweden](https://www.scb.se/en/finding-statistics/regional-statistics/regional-divisions/counties-and-municipalities/),
  ...
  administrative facts and have not changed since Skåne, Halland and
